export const FailSafeCpp = () => {
    return <div className="flex w-full h-full">
        <div className="w-2/3 pr-8">
            <p className="pb-4 font-bold text-custom-title"> C++ </p>
            <p className="pb-8 text-custom-text">~95% of the game is made in C++. I've used Blueprints only for the tutorial and the crouch animation,
                 as it had to be done fast at that moment.</p> 
